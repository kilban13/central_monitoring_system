...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2019 at 06:38 PM
...
CREATE TABLE `centers` (
  ...
  `center_code` int(10) UNSIGNED NOT NULL,
  `center_type` int(11) NOT NULL DEFAULT '1',
...
(3, '2019_03_13_112525_create_1552469125_roles_table', 1),
(4, '2019_03_13_112529_create_1552469128_users_table', 1),
(5, '2019_03_13_112530_add_5c88cc8d57b8c_relationships_to_user_table', 1),
(6, '2019_04_02_095042_create_centers_table', 2),
(7, '2019_04_03_055315_create_students_table', 3),
(8, '2019_04_03_055646_create_teachers_table', 3),
...
(1, 'Administrator (can create other users)', '2019-03-13 03:50:57', '2019-03-13 03:50:57'),
(2, 'ADP', '2019-03-13 03:50:57', '2019-04-05 10:38:09'),
(3, 'Supervisor', '2019-04-05 10:38:24', '2019-04-05 10:38:24');
...
INSERT INTO `users` (`id`, `name`, `district_id`, `office_id`, `org_id`, `designation_id`, `office_phone`, `org_phone`, `cell_phone`, `home_phone`, `fax`, `attachement`, `date`, `created_by`, `updated_by`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `role_id`) VALUES
(1, 'Admin', 1, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 'admin@admin.com', NULL, '$2y$10$HwM/PcPT7ptUoXrXfQDztOHeYW0yTt.NmlM2XBKC6CNqLSm3NKJyK', 'KyjQvg29g6rOr87a7OLLZHUxCtF9B55k65nuu7P83BrjTwqCIDUiEaeitd8K', NULL, NULL, 1);
...
ALTER TABLE `centers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `centers_district_id_index` (`district_id`),
  ADD KEY `centers_thana_id_index` (`thana_id`),
  ADD KEY `centers_center_code_index` (`center_code`);
